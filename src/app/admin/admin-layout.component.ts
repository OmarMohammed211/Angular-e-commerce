    ...
    <div class="flex h-screen bg-slate-950 text-slate-200">
      ...
      <aside class="w-64 bg-slate-900 border-r border-slate-800 flex flex-col transition-all duration-300">
        ...
        <nav class="flex-1 p-4 space-y-2">
          <a routerLink="/admin/dashboard" routerLinkActive="bg-blue-600/10 text-blue-400 border-r-2 border-blue-500" class="flex items-center px-4 py-3 rounded-lg text-slate-400 hover:bg-slate-800 hover:text-slate-200 transition-colors">
          ...
          <a routerLink="/admin/orders" routerLinkActive="bg-blue-600/10 text-blue-400 border-r-2 border-blue-500" class="flex items-center px-4 py-3 rounded-lg text-slate-400 hover:bg-slate-800 hover:text-slate-200 transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
